...
export default function PhoGardenExperience() {
  ...
  return <main className={cn(dark && 'dark')}><motion.div style={{ scaleX }} className="fixed left-0 right-0 top-0 z-[90] h-1 origin-left bg-gold" /><Header dark={dark} setDark={setDark} /><Hero /><Story /><SignatureCarousel /><MenuSection /><Gallery /><Testimonials /><FormsAndContact /><Extras /><Footer /><BackToTop /></main>;
}
